  ...
  return (
    ...
    >
      <Image
        ...
        height={300}
      />
      <motion.div className="absolute top-[250px] group-hover:top-2/10 transition-all duration-200 ease-in-out max-h-[504px] max-w-[151px] md:max-w-[246px] right-1/10 ">
        <Image
          src={device}
