...
const ProjectHero = (props: Props) => {
  return (
    <>
      {/* Desktop view */}
      <div className="bg-white responsive-padding w-dvw hidden lg:flex flex-col lg:flex-row  justify-between items-center flex-wrap lg:h-[600px] lg:gap-24 lg:py-[100px] relative py-12">
        <Link
          href="/work"
